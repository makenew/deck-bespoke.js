...
(function() {
  ...
  require.register('bespoke-keys', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'bespoke-keys//lib/')); }), {});
...
require.register('bespoke-theme-cube', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'bespoke-theme-cube//dist/')); }), {});
    (function(exports,require,module) {
      /*!
...
require.register('bespoke', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'bespoke//lib/')); }), {});
    (function(exports,require,module) {
...
exports.default = function () {
  (0, _deck2.default)('#deck');
};

});

require.register("modules/deck", function(exports, require, module) {
'use strict';
...
var _bespoke = require('bespoke');

var _bespoke2 = _interopRequireDefault(_bespoke);

var _bespokeKeys = require('bespoke-keys');

var _bespokeKeys2 = _interopRequireDefault(_bespokeKeys);

var _bespokeThemeCube = require('bespoke-theme-cube');

var _bespokeThemeCube2 = _interopRequireDefault(_bespokeThemeCube);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var plugins = [(0, _bespokeKeys2.default)(), (0, _bespokeThemeCube2.default)()];

exports.default = function (element) {
  _bespoke2.default.from(element, plugins);
};
